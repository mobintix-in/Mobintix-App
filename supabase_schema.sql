...
values
  ('E-Commerce Website', 'Web', 'Comprehensive analytics platform for retailers.', 'https://lh3.googleusercontent.com/p/AF1QipMrkIkUSNWST_0pZSzOSl8_bMQhG3OWtb3Ogclh=h305-no', array['Wordpress', 'PHP', 'WooCommerce'], 'https://kgmediastudio.com/'),
  ('FinTech Dashboard', 'Web', 'Financial analytics with real-time data visual.', 'https://images.pexels.com/photos/265087/pexels-photo-265087.jpeg?auto=compress&cs=tinysrgb&w=800', array['React', 'TypeScript', 'D3.js'], 'https://linktr.ee/mobintix'),
  ('E-Commerce Mobile App', 'Mobile', 'Cross-platform shopping app with seamless checkout experience', 'https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=800', array['React Native', 'Redux', 'Stripe'], 'https://linktr.ee/mobintix'),
  ('Healthcare Portal', 'Web', 'Patient management system with appointment scheduling and telemedicine', 'https://images.pexels.com/photos/3825517/pexels-photo-3825517.jpeg?auto=compress&cs=tinysrgb&w=800', array['Vue.js', 'Node.js', 'MongoDB'], 'https://linktr.ee/mobintix'),
  ('Brand Identity System', 'Design', 'Complete brand identity and design system for a tech startup', 'https://images.pexels.com/photos/196644/pexels-photo-196644.jpeg?auto=compress&cs=tinysrgb&w=800', array['Figma', 'UI/UX', 'Brand Design'], 'https://linktr.ee/mobintix'),
  ('Fitness Tracking App', 'Mobile', 'iOS and Android app for tracking workouts and nutrition', 'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&w=800', array['Flutter', 'Firebase', 'HealthKit'], 'https://linktr.ee/mobintix'),
  ('Luxury Fashion Store', 'E-Commerce', 'High-end e-commerce platform with AR try-on features', 'https://images.pexels.com/photos/972995/pexels-photo-972995.jpeg?auto=compress&cs=tinysrgb&w=800', array['Next.js', 'Shopify', 'AR'], 'https://linktr.ee/mobintix'),
  ('SaaS Analytics Platform', 'Web', 'Business intelligence platform for enterprise clients', 'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=800', array['Angular', 'Python', 'PostgreSQL'], 'https://linktr.ee/mobintix');
